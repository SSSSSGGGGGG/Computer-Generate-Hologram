...
im_rh=plt.imread("R(blazed)_p64.png")
# im_gh=plt.imread("Green(H)_p54.png")
im_bh=plt.imread("B(blazed)_p46.png")
...
im_rh_pil.save('M_RB_blazed.tif', save_all=True, append_images=[im_bh_pil])
...
im_m =Image.open('M_RB_blazed.tif')
