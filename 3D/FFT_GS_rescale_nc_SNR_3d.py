...
filename1="1" #flowers_tf  RGB 3circles_exp RGB_500 fl_one
im1=plt.imread(f"{filename1}.png")

filename2="2" #flowers_tf  RGB 3circles_exp RGB_500 fl_one
im2=plt.imread(f"{filename2}.png")

filename3="3" #flowers_tf  RGB 3circles_exp RGB_500 fl_one
im3=plt.imread(f"{filename3}.png")

filename4="4" #flowers_tf  RGB 3circles_exp RGB_500 fl_one
im4=plt.imread(f"{filename4}.png")

filename5="5" #flowers_tf  RGB 3circles_exp RGB_500 fl_one
im5=plt.imread(f"{filename5}.png")
...
iterations1, iterations2,power1=20,0,2
holo_im_r,holo_im_g,holo_im_b=holo(im1,-1,iterations1, iterations2,power1)
holo_im2_r,holo_im2_g,holo_im2_b=holo(im2,-0.9,iterations1, iterations2,power1)
holo_im3_r,holo_im3_g,holo_im3_b=holo(im3,-0.7,iterations1, iterations2,power1)
holo_im4_r,holo_im4_g,holo_im4_b=holo(im4,-0.6,iterations1, iterations2,power1)
holo_im5_r,holo_im5_g,holo_im5_b=holo(im5,-0.5,iterations1, iterations2,power1)

current_field_r=holo_im_r+holo_im2_r+holo_im3_r+holo_im4_r+holo_im5_r
current_field_g=holo_im_g+holo_im2_g+holo_im3_g+holo_im4_g+holo_im5_g
current_field_b=holo_im_b+holo_im2_b+holo_im3_b+holo_im4_b+holo_im5_b
...
im_modify_noL = np.zeros_like(im1,shape=(im1.shape[0], im1.shape[1], 3))
