...
im_rh=plt.imread("C:/Users/Laboratorio/MakeHologram/GrayScript/R(blazed)_p200.png")
# im_gh=plt.imread("Green(H)_p54.png")
im_bh=plt.imread("C:/Users/Laboratorio/MakeHologram/GrayScript/R(blazed)V_p400.png")

im_rb=plt.imread("C:/Users/Laboratorio/MakeHologram/GrayScript/R_tri_92(V)_p48.png")
...
im_new_3.save('R_bl2_tri_p200.png')
