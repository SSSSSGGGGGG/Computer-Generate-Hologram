...
im_new_array[:,:,0] = phase_rr_new
im_new_array[:,:,1] = phase_gr_new
im_new_array[:,:,2] = phase_br_new
im_new_array = im_new_array.astype(np.uint8)
im_new = Image.fromarray(im_new_array)
im_new.save(f"{filename}_RGB_rand.png")
...
im_modi.save(f"{filename}_RGB_randModi.png")
# im_modi.show()
