...
im_rh=plt.imread("C:/Users/Laboratorio/MakeHologram/RGBScript/G(blazed)_p320.png")
# im_gh=plt.imread("Green(H)_p54.png")
im_bh=plt.imread("C:/Users/Laboratorio/MakeHologram/RGBScript/G(blazed)V_p640.png")

im_rb=plt.imread("C:/Users/Laboratorio/MakeHologram/RGBScript/Green_tri_150(V)_p54.png")
...
im_new.save('RGB_G_bl2_p320.png')
...
im_new_3.save('RGB_G_bl2_tri_p320.png')
