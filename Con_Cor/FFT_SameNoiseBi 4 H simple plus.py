...
def con_cor_Bi(phase_r1,phase_r2,phase_g1,phase_g2,phase_b1,phase_b2,type_):
    ...
    if type_=="tri":
            ...
            gr,gg,gb=136,136,136
    phase_r1_gray,phase_g1_gray,phase_b1_gray=convToGray_nB(phase_r1, phase_g1, phase_b1) 
    
    phase_r2_gray=phase_r2*gr
    phase_g2_gray=phase_g2*gg
    phase_b2_gray=phase_b2*gb
    
    con_r_gray=phase_r1_gray+phase_r2_gray
    con_g_gray=phase_g1_gray+phase_g2_gray
    con_b_gray=phase_b1_gray+phase_b2_gray
