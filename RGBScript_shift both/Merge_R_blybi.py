...
im_rh=plt.imread("C:/Users/Laboratorio/MakeHologram/RGBScript_shift both/R(blazed)_p79.png")
# im_gh=plt.imread("Green(H)_p54.png")
im_bh=plt.imread("C:/Users/Laboratorio/MakeHologram/RGBScript_shift both/R(blazed)V_p400.png")

im_rb=plt.imread("C:/Users/Laboratorio/MakeHologram/RGBScript_shift both/R_tri_92(V)_p70.png")
# im_shift=plt.imread("C:/Users/Laboratorio/MakeHologram/RGBScript_shift both/R(blazed)_p128.png")
...
im_m[:,:,0]=im_rh_array[:,:,0]+im_bh_array[:,:,0]#+im_shift_array[:,:,0]
im_check=im_m[:,:,0] #!!!!!!!!!!!
...
im_m_3[:,:,0]=im_rh_array[:,:,0]+im_bh_array[:,:,0]+im_rb_array[:,:,0]#+im_shift_array[:,:,0]
im_check_3=im_m_3[:,:,0]
...
im_new_3.save('RGB_R_bl2_tri.png')
