...
for i in range(iterations):
    ...
    # plt.figure()
    # plt.imshow(abs(current_field_r_n),cmap="Reds")
    # plt.title("R")
    # plt.show()
    # plt.figure()
    # plt.imshow(abs(current_field_g_n),cmap="Greens")
    # plt.title("G")
    # plt.show()
    # plt.figure()
    # plt.imshow(abs(current_field_b_n),cmap="Blues")
    # plt.title("B")
    # plt.show()
...
red_channel, green_channel, blue_channel = im_modi.split()
