...
im_lens=plt.imread("C:/Users/Laboratorio/MakeHologram/Lens/Lens_rgb(1.8, 1024).png")
im=plt.imread("C:/Users/Laboratorio/MakeHologram/FFT of imgs/RGB100p_RGB_rand_M_scaled.png")

im_lens_array = np.array(im_lens)*255
...
im_new.save('RGB_spots_lens_1.8.png')
