...
im_b=plt.imread("C:/Users/Laboratorio/MakeHologram/RGBScript_shift both/B_tri_112(V)_p48.png")
...
im_bi_l.save('B_bi_lens.png')
im_bi_l.show()

"""Read blazed gratings for blue"""
im_b_bls=plt.imread("C:/Users/Laboratorio/MakeHologram/RGBScript_shift both/B(blazed)_p92.png")
