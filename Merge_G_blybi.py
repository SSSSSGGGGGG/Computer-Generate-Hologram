...
im_rh=plt.imread("C:/Users/Laboratorio/MakeHologram/G(blazed)_p364.png")
# im_gh=plt.imread("Green(H)_p54.png")
im_bh=plt.imread("C:/Users/Laboratorio/MakeHologram/G(blazed)V_p728.png")

im_rb=plt.imread("C:/Users/Laboratorio/MakeHologram/Green_tri_140(V)_p54.png")
...
im_new_3.save('G_bl2_bi_tri.png')
